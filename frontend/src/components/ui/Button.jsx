...
const Button = React.forwardRef(({ 
  ...
  const variants = {
    ...
    secondary: "bg-white text-neutral-700 hover:bg-neutral-50 border border-neutral-300 focus:ring-primary-500 shadow-sm",
    ...
    ghost: "bg-transparent text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 focus:ring-neutral-500"
  };
